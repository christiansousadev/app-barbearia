...
class Home : AppCompatActivity() {
    ...
    private fun getServicos(){
        ...
        val servico2 = Servicos(R.drawable.barba2,"Barba e bigode")
        listaServicos.add(servico2)

        val servico3 = Servicos(R.drawable.cabelo,"Cortes especiais")
        listaServicos.add(servico3)

        val servico4 = Servicos(R.drawable.tratamento,"Tratamento de cabelo")
